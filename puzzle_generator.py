...
# height = width = 8
# unique_edge_colors_count = 3
# unique_inner_colors_count = 16

# height = width = 6
# unique_edge_colors_count = 3
# unique_inner_colors_count = 7

# height = width = 5
# unique_edge_colors_count = 3
# unique_inner_colors_count = 6
...
# height = width = 4
# unique_edge_colors_count = 4
# unique_inner_colors_count = 5

# height = 8
# width = 7
# unique_edge_colors_count = 4
# unique_inner_colors_count = 14
...
corners = [PieceDef() for i in range(4)]
edges = [PieceDef() for i in range(edges_count)]
inner = [PieceDef() for i in range(inner_count)]
...
board = [width*[0] for i in range(height)]
E = 0
S = 1
W = 2
N = 3
...
if not color_counts:
    ...
    for i in range(inner_color_subpieces):
        random_inner_permutation[i] = random.randint(unique_edge_colors_count + 1, unique_edge_colors_count + unique_inner_colors_count)
else:
...
print(f"height={height}, "
      f"width={width}, "
      f"pieces={pieces_count}, "
      f"corners={corners_count}, "
      f"edges={edges_count}, "
      f"inner={inner_count},"
      f"edge_color_subpieces={edge_color_subpieces},"
      f"inner_color_subpieces={inner_color_subpieces}")
...
with open(f"{height}_{width}_edge{unique_edge_colors_count}_inner{unique_inner_colors_count}_solution.csv", "w") as f:
